...
from rg_utils import gather_search_results, CodeMatchedResult, CodeMatch, CodeLine


_simple_rg_output = """\
/Users/nednguyen/projects/RISE_old/src/Library/RasterImages/RGBEAWriter.cpp
45-	char szHeader[2048] = {0};
46-	{
47-		static const char * szSignature = "#?RGBEA\n";
48-		char szWhoWroteIt[256] = {0};
49:		sprintf( szWhoWroteIt, "# Generated by R.I.S.E. v%d.%d.%d build %d\n", RISE_VER_MAJOR_VERSION, RISE_VER_MINOR_VERSION, RISE_VER_REVISION_VERSION, RISE_VER_BUILD_VERSION );
50-		static const char * szImageType = "FORMAT=64-bit_rle_rgbea\n\n";
51-		char szImageDimensions[256] = {0};

/Users/nednguyen/projects/RISE_old/src/Library/RasterImages/HDRWriter.cpp
46-	char szHeader[2048] = {0};
47-	{
48-		static const char * szSignature = "#?RADIANCE\n";
49-		char szWhoWroteIt[256] = {0};
50:		sprintf( szWhoWroteIt, "# Generated by R.I.S.E. v%d.%d.%d build %d\n", RISE_VER_MAJOR_VERSION, RISE_VER_MINOR_VERSION, RISE_VER_REVISION_VERSION, RISE_VER_BUILD_VERSION );
51-		static const char * szImageType = "FORMAT=32-bit_rle_rgbe\n\n";
52-		char szImageDimensions[256] = {0};
...
0.017989 seconds spent searching
0.046190 seconds
"""

_no_matches_rg_output = """\
0 matches
0 matched lines
...
class TestGatherSearchResults(unittest.TestCase):
    def setUp(self):
        ...
        self.basic_rg_args = "-e 'sprintf\s*\(' -n --with-filename -C 2 --stats"

        # Sample rg output with matches
        self.sample_rg_output = """\
/path/to/file1.py
...
"""
    ...
    def test_successful_search_with_matches(self, mock_run_rg):
        ...
        mock_result.stdout = self.sample_rg_output
        mock_result.stderr = ""
        ...
        self.assertEqual(second_match.end_line, 7)
        self.assertEqual(len(second_match.lines), 3)
    ...
    def test_search_with_complex_output(self, mock_run_rg):
        ...
        for i, match in enumerate(result.matches):
            self.assertIsInstance(match, CodeMatch)
            self.assertTrue(match.filepath.startswith("/Users/Test/RISE"))
    ...
    def test_search_with_missing_required_flags(self, mock_run_rg):
        # Test with missing required flags - should still work as function adds them
        ...
        # Execute
        result = gather_search_results(incomplete_args, self.test_folder)
